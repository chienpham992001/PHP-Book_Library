...
<body>
    <div class="wrapper">
        ...
        require 'config.php';
        $id = $_GET['id'];
        $sql = "SELECT book_name,qty,cost,borrow_date,return_date FROM book_borrow INNER JOIN book ON book_borrow.book_id = book.book_id INNER JOIN user ON user.user_id = book_borrow.user_id WHERE (oder_detail_id = '$id' AND status = 'Đang mượn')
        UNION ALL
        SELECT book_name,qty,cost,back_date,return_date FROM book_return INNER JOIN book ON book_return.book_id = book.book_id INNER JOIN user ON user.user_id = book_return.user_id WHERE ( status = 'Đã trả' OR status ='Trả muộn') AND oder_detail_id = '$id'";
        ...
        <div class="content-wrapper" style="clear: both;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Chi tiết phiếu mượn</h1>
                        </div><!-- /.col -->
