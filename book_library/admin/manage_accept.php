  ...
  <style type="text/css">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Quản lý yêu cầu mượn</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container">
        <div class="buttons">
            <a href="add_borrow2.php" ><button class="btn-primary">Mượn sách</button></a>
        </div>
          <table class="table table-bordered mt-3 .bg-light">
            ...
            ?>
            <tr>
                <td><?php echo $row['oder_detail_id']; ?></td>
                ...
                <td width="20%;"><a href="edit_borrow.php?id=<?php echo $row['borrow_id']; ?>" class="btn btn-primary btn-sml" >Xác nhận</a>
                <!-- <a href="delete_borrow.php?id=<?php echo $row['borrow_id']; ?>" class="btn btn-danger btn-sml" >Hủy</a> -->
                <input type="button" onClick = "deleteme(<?php echo $row['borrow_id']; ?>)" name="delete" value="Từ chối" class="btn btn-danger btn-sml">                
            </tr>
        <?php } ?>
            </tbody>
        </table>
    ...
    <script type="text/javascript">
        function deleteme(delid) {
            if(confirm("Bạn có muốn từ chối yêu cầu mượn sách này ?")){
